    ...
    const renderQuestion = () => {
        return (
            <View>
                ...
                {/* question */}
                <Text style={{ fontSize: 30, fontWeight: 'bold' }}>{allQuestions[8]?.question}</Text>
            </View>
        )
        ...
        return (
            <View>
                ...
                <TouchableOpacity style={[styles.option, { backgroundColor: optionColor4 }]} onPress={checkedOption4}>
                    <Text style={{ fontSize: 18 }}>Kurang peduli</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.option, { backgroundColor: optionColor5 }]} onPress={checkedOption5}>
                    <Text style={{ fontSize: 18 }}>Sangat tidak peduli</Text>
                </TouchableOpacity>
            </View>
        )
    }
